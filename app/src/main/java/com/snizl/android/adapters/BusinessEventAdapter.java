...
public class BusinessEventAdapter extends RecyclerView.Adapter<BusinessEventAdapter.ViewHolder> implements AppConfig {
    private Context context;
    private JSONArray events;

    WeakReference<BusinessEventActionListener> listener;

    public interface BusinessEventActionListener {
    ...
    public BusinessEventAdapter(Context context, JSONArray events, BusinessEventActionListener listener) {
