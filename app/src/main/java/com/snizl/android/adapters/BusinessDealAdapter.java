...
public class BusinessDealAdapter extends RecyclerView.Adapter<BusinessDealAdapter.ViewHolder> implements AppConfig {
    private Context context;
    private JSONArray offers;

    WeakReference<BusinessDealActionListener> listener;

    public interface BusinessDealActionListener {
    ...
    public BusinessDealAdapter(Context context, JSONArray offers, BusinessDealActionListener listener) {
